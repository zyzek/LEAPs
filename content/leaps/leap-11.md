...
The success of Lyra thus far has been in large part due to the vibrant Discord community and the early users and LPs of the protocol. This LEAP requests that the Council authorize up to 15,000,000 LYRA tokens (1.5% of total supply) to be distributed to community members and users of the Protocol, with a snapshot of relevant contributions to be taken at 21:00 UTC Time 25/11/2021. 
