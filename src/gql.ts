...
export type SipFrontmatterFragment = Pick<MarkdownRemarkFrontmatter, 'sip' | 'title' | 'author' | 'discussions_to' | 'created' | 'status'>;
...
export type AllSccpQuery = { allMarkdownRemark: { group: Array<(
      ...
      & { nodes: Array<(
        ...
        & { frontmatter?: Maybe<Pick<MarkdownRemarkFrontmatter, 'sccp' | 'title' | 'created' | 'author'>> }
      )> }
    )> } };
...
export type AllSipsQuery = { allMarkdownRemark: { group: Array<(
      ...
      & { nodes: Array<(
        Pick<MarkdownRemark, 'id'>
        & { frontmatter?: Maybe<Pick<MarkdownRemarkFrontmatter, 'sip' | 'title' | 'created' | 'author'>> }
      )> }
    )> } };

export type SipPageQueryVariables = Exact<{
  frontmatter__sip: Scalars['Int'];
}>;


export type SipPageQuery = { markdownRemark?: Maybe<(
    Pick<MarkdownRemark, 'html'>
    & { frontmatter?: Maybe<SipFrontmatterFragment> }
  )> };
